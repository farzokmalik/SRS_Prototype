  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        {renderManpowerTable('MANPOWER DURING ADMINISTRATIVE IMPLEMENTATION OF THE Program', 'adminManpower')}
        {renderManpowerTable('MANPOWER DURING EXECUTION AND OPERATIONS OF THE Program', 'execManpower')}
        {renderManpowerTable('MANPOWER AFTER COMPLETION OF THE Program', 'postManpower')}
      </div>
    </div>
  );
};
