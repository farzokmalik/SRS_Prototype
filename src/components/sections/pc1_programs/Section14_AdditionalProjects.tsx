...
export const Section14_AdditionalPrograms: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div className="card">
        <RTEditor label="Additional Program Decision Requirement Information" value={data.description} onChange={(val) => handleUpdate({ description: val })} />
      </div>
