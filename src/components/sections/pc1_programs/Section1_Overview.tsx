    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.25rem', fontWeight: 600, color: 'hsl(var(--primary))', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <span style={{ width: '32px', height: '32px', borderRadius: 'var(--radius-md)', background: 'hsl(var(--accent-soft))', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'hsl(var(--accent))' }}>
            $
          </span>
          {data1.statusType?.includes('Programme') ? 'Program' : 'Project'} Total Cost & Approval Details
        </h2>
