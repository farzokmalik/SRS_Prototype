      ...
      <div className="card shadow-sm">
        ...
        <div style={{ padding: '0 1rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(180px, 1fr) 1fr 1fr 1fr 48px', gap: '1.5rem', marginBottom: '0.75rem' }}>
            <div style={{ textAlign: 'left', fontSize: '0.94rem', fontWeight: 700, color: 'hsl(var(--text-main) / 0.8)' }}>[PCN-10.1] Year</div>
            <div style={{ textAlign: 'left', fontSize: '0.94rem', fontWeight: 700, color: 'hsl(var(--text-main) / 0.8)' }}>[PCN-10.2] Local Amount</div>
            <div style={{ textAlign: 'left', fontSize: '0.94rem', fontWeight: 700, color: 'hsl(var(--text-main) / 0.8)' }}>[PCN-10.3] Foreign Amount</div>
            <div style={{ textAlign: 'left', fontSize: '0.94rem', fontWeight: 700, color: 'hsl(var(--text-main) / 0.8)' }}>[PCN-10.4] Total Amount</div>
            <div></div>
          </div>
