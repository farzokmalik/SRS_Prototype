...
export const Section4_Funding: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      <div className="card">
        <SelectField 
          label="[PC-I-4.1] Source of Funding" 
        ...
        {data.fundingSource === 'ADP' && (
          <div style={{ marginTop: '1rem', padding: '1rem', background: '#f8f9fa', borderRadius: 'var(--radius-md)' }}>
            <div style={{ position: 'relative', marginBottom: '1rem' }}>
              <label className="label">[PC-I-4.2] Search GS No.</label>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
              <InputField label="[PC-I-4.3] SMDP Scheme No" value={data.smdpNo} readOnly />
              <InputField label="GS No." value={data.gsNoResult} readOnly />
              <div className="input-group">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.25rem' }}>
                  <label className="label">[PC-I-4.4] Total Allocation</label>
        ...
        {data.fundingSource === 'Re-appropriation' && (
          <div style={{ marginTop: '1rem' }}>
            <RadioGroup 
              label="[PC-I-4.5] Re-appropriation Type" 
              name="reapp"
      ...
      <div className="card">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', alignItems: 'flex-start' }}>
          <div className="input-group">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <label className="label">[PC-I-4.6] Proposed Allocation</label>
              <span style={{ fontSize: '0.8rem', fontWeight: 600, color: 'hsl(var(--accent))' }}>Millions</span>
            </div>
           ...
           <RadioGroup 
             label="[PC-I-4.7] Purpose of Funding" 
             name="purpose"
             value={data.purpose}
        ...
        <RTEditor label="[PC-I-4.8] Comments" value={data.comments} onChange={(val) => handleUpdate({ comments: val })} />
      </div>
    </div>
  );
};
